...
// BmpReadingDoc.cpp: CBmpReadingDoc 클래스의 구현
//
...
IMPLEMENT_DYNCREATE(CBmpReadingDoc, CDocument)

BEGIN_MESSAGE_MAP(CBmpReadingDoc, CDocument)
END_MESSAGE_MAP()


// CBmpReadingDoc 생성/소멸

CBmpReadingDoc::CBmpReadingDoc() noexcept
{
	// TODO: 여기에 일회성 생성 코드를 추가합니다.

}

CBmpReadingDoc::~CBmpReadingDoc()
{
}

BOOL CBmpReadingDoc::OnNewDocument()
{
...
// CBmpReadingDoc serialization

void CBmpReadingDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
// 축소판 그림을 지원합니다.
void CBmpReadingDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CBmpReadingDoc::InitializeSearchContent()
{
...
void CBmpReadingDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
...
#ifdef _DEBUG
void CBmpReadingDoc::AssertValid() const
{
	CDocument::AssertValid();
}

void CBmpReadingDoc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
